...
<div>
	...
	<div
		...
		for (Student s : students) {
			...
			+ s.getCountry() + "</td><td><a href='/Lab5_studentDebate/Student/delete-student?id=" + s.getId() + "'>Delete</a></td><td><a href='/Lab5_studentDebate/Student/update-student/" + s.getId() + "'>Update</a></td></tr>");
		}
